            ...
            <div class="breadcrumb-content">
                ...
                <div class="d-flex flex-wrap align-items-center pt-3">
                    ...
                    @php
                        ...
                        $average_rev = App\Models\Review::where('course_id', $course->id)->where('status', 1)->avg('rating');
                    @endphp

                    <div class="rating-wrap d-flex flex-wrap align-items-center">
                        <div class="review-stars">
                            <span class="rating-number">{{ round($average_rev,1) }}</span>
                            ...
                            @if ($average_rev == 0)
                                ...
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                            @elseif ($average_rev == 1 || $average_rev < 2)
                                <span class="la la-star"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                            @elseif ($average_rev == 2 || $average_rev < 3)
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                            @elseif ($average_rev == 3 || $average_rev < 4)
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star-o"></span>
                                <span class="la la-star-o"></span>
                            @elseif ($average_rev == 4 || $average_rev < 5)
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star-o"></span>
                            @elseif ($average_rev == 5 || $average_rev < 5)
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                                <span class="la la-star"></span>
                        ...
                        @php
                            $enrolledStudents = App\Models\Order::where('course_id', $course->id)->count();
                        @endphp

                        <span class="student-total pl-2">{{ number_format($enrolledStudents) }} students</span>
                    </div>
                </div><!-- end d-flex -->
        ...
        <div class="row">
           <div class="col-lg-8 pb-5">
               <div class="course-details-content-wrap pt-90px">
                           ...
                           <div class="media media-card">
                               <div class="instructor-img">
                                   <a href="teacher-detail.html" class="media-img d-block">
                                       <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('upload/instructor_images/'.$course->user->photo) : url('upload/no_image.jpg')}}" alt="Avatar image">
                                   </a>
                       ...
                       <div class="feedback-wrap">
                           <div class="media media-card align-items-center">
                               <div class="review-rating-summary">
                                    <span class="stats-average__count">{{ round($average_rev,1) }}</span>
                               ...
                               <div class="media-body">
                                ...
                                @endphp
                                    ...
                                    <div class="review-bars d-flex align-items-center mb-2">
                                       ...
                                       <div class="review-bars__percent">{{ number_format($ratingInfo['percent'],1) }}%</div>
                                   </div><!-- end review-bars -->
                           ...
                           @foreach ($reviews as $item)
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                               ...
                               <div class="media-body">
                                   ...
                                   <p class="pb-2 text-black">{{ $item->comment }}</p>
                   ...
                   @guest
                   <p> <b>You need to login to add a review. <a href="{{ route('login') }}" class="text-danger">Login Here</a> </b> </p>
                   @else
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="buy-course-btn-box">
                                    ...
                                    <div class="input-group mb-2" id="couponField">
                                        <input class="form-control form--control pl-3" type="text" id="coupon_name" placeholder="Course coupon">
                                        <div class="input-group-append">
                                            <input type="hidden" id="course_id" name="course_id" value="{{ $course->id }}">
                                            <input type="hidden" id="instructor_id" name="instructor_id" value="{{ $course->instructor_id }}">
                                            <a type="submit" onclick="applyInsCoupon()" class="btn theme-btn text-white">Apply Code</a>
                                        </div>
                                    </div>
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <ul class="generic-list-item pb-3">
                                        ...
                                        <li><i class="la la-file-text mr-2 text-color"></i>{{ $course->resources }} resources</li>
                                        <li><i class="la la-code mr-2 text-color"></i>coding exercises</li>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i class="la la-play-circle-o mr-2 text-color"></i>Lectures</span> {{ count($lecture) }}</li>
