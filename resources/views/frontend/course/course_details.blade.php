...
@section('home')
    ...
    @section('title')
        {{ $course->course_name }} | Aduca Learning
    @endsection
            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li>{{ $course['category']['category_name'] }}</li>
                        <li>{{ $course['subcategory']['subcategory_name'] }}</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                                        ...
                                        @if (count($percentages) > 0)
                                            ...
                                            @foreach ($percentages as $ratingInfo)
                                                ...
                                                <div class="review-bars d-flex align-items-center mb-2">
                                                    ...
                                                    <div class="review-bars__percent">{{ number_format($ratingInfo['percent'], 1) }}%
                                                    </div>
                                                </div><!-- end review-bars -->
                        ...
                        @guest
                            <p> <b>You need to login to add a review. <a href="{{ route('login') }}" class="text-danger">Login
                                        Here</a> </b> </p>
                        @else
                                        ...
                                        <div class="input-group mb-2" id="couponField">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <a type="submit" onclick="applyInsCoupon()"
                                                    class="btn theme-btn text-white">Apply Code</a>
                                            </div>
                                        </div>
                        ...
                        {{-- <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="view-all-course-btn-box">
                                    <a href="{{ route('blog') }}" class="btn theme-btn w-100">View All Courses <i
                    ...
                    @foreach ($instructorCourses as $inscourse)
                        ...
                        <div class="card card-item">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{{ $inscourse['user']['name'] }}</p>
