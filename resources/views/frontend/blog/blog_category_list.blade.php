...
@section('title')
{{ $bcatname->category_name }} | Blog Category | Springtech Learning
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">{{ $bcatname->category_name }}</h2>
            </div>
            <ul class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="index.html">Home</a></li>
                <li>Blog Category</li>
                <li>{{ $bcatname->category_name }}</li>
            </ul>
                    ...
                    @foreach ($blog as $item)
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                <a href="{{ url('blog/detials/'.$item->post_slug) }}" class="d-block">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="{{ url('blog/detials/'.$item->post_slug) }}">{{ $item->post_title }}</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3">
                                    <a href="{{ url('blog/detials/'.$item->post_slug) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="la la-arrow-right icon ml-1"></i></a>
                ...
                <div class="sidebar">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                @foreach ($bcategory as $bcat)
                                    <li><a href="{{ url('blog/cat/list/'.$bcat->id) }}">{{ $bcat->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            @foreach ($post as $bpost)
                                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <a href="{{ url('blog/detials/'.$bpost->post_slug) }}" class="media-img">
                                    <img class="mr-3" src="{{ asset($bpost->post_image) }}" alt="Related course image">
                                </a>
                                <div class="media-body">
                                    <h5 class="fs-15"><a href="{{ url('blog/detials/'.$bpost->post_slug) }}">{{ $bpost->post_title }}</a></h5>
                                    <span class="d-block lh-18 py-1 fs-14">By Admin</span>
                                </div>
                                </div><!-- end media -->
                            @endforeach
