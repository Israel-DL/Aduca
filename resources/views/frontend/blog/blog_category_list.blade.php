...
@section('home')
    ...
    @section('title')
        {{ $bcatname->category_name }} | Blog Category | Aduca Learning
    @endsection
                                ...
                                <div class="card card-item">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><a
                                                href="{{ url('blog/detials/' . $item->post_slug) }}">{{ $item->post_title }}</a>
                                        </h5>
                                        <ul
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pt-3">
                                            <a href="{{ url('blog/detials/' . $item->post_slug) }}"
                                ...
                                @foreach ($post as $bpost)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        ...
                                        <div class="media-body">
                                            <h5 class="fs-15"><a
                                                    href="{{ url('blog/detials/' . $bpost->post_slug) }}">{{ $bpost->post_title }}</a>
                                            </h5>
