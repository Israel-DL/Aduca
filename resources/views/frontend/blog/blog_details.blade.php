...
@section('home')
    ...
    @section('title')
        {{ $blog->post_title }} Aduca Learning
    @endsection
                    ...
                    {{-- <div class="instructor-wrap py-5">
                        ...
                        <div class="media media-card">
                            ...
                            <div class="media-body">
                                ...
                                <p class="pb-3">I'm a growth-oriented digital marketer with a passion for content marketing,
                                    social media marketing wonders, conversion rate optimization, and keyword research. I
                                    strongly support permission marketing and earned media. More than anything</p>
