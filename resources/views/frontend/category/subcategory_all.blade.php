...
@section('home')
    ...
    @section('title')
        {{ $subcategory->subcategory_name }} Sub-Category | Aduca Learning
    @endsection
        ...
        <div class="container">
            <div class="filter-bar mb-4">
                <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                    <p class="fs-14">We found <span class="text-black">{{ count($courses) }}</span> courses under this
                        subcategory</p>
                    {{-- <div class="d-flex flex-wrap align-items-center">
                        <ul class="filter-nav mr-3">
                            <li><a data-toggle="tooltip" data-placement="top" title="Grid View" class="active"><span
                                ...
                                <div class="card card-item card-preview" >
                                    <div class="card-image">
                                        ...
                                        <div class="course-badge-labels">
                                            ...
                                            @else
                                                <div class="course-badge blue">{{ round($discount) }}% discount</div>
                                            @endif
                                        </div>
                                    </div><!-- end card-image -->
                                    <div class="card-body">
