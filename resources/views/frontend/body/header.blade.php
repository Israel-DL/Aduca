                ...
                <div class="col-lg-6">
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-phone mr-1"></i><a href="tel:{{ $setting->phone }}">{{ $setting->phone }}</a></li>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            ...
                                            @php
                                            $subcategory = App\Models\SubCategory::where('category_id',$cat->id)->get();
                                            @endphp
