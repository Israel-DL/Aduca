...
<section class="register-area section--padding dot-bg overflow-hidden">
    <div class="container">
        <div class="register-heading-content-wrap text-center">
            <div class="section-heading">
                <h2 class="section__title">Fill Up this Form to Join our Platform</h2>
            </div><!-- end section-heading -->
        </div>
                        ...
                        <form method="post" action="{{ route('instructor.register') }}" class="row">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid @enderror" type="text" name="name" placeholder="e.g. Alex Scott">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control  @error('email') is-invalid @enderror" type="email" name="email" placeholder="e.g. alexscott@gmail.com">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control  @error('phone') is-invalid @enderror" type="text" name="phone" placeholder="e.g. 07092193201">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control  @error('address') is-invalid @enderror" type="text" name="address" placeholder="e.g. No4 Ajawo-Estate Ikeja Nigeria">
