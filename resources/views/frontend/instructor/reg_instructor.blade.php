...
@section('home')
    ...
    @section('title')
        Become An Instructor | Aduca Learning
    @endsection
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('name') is-invalid @enderror"
                                            type="text" name="name" placeholder="e.g. Alex Scott">
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control  @error('username') is-invalid @enderror"
                                            type="text" name="username" placeholder="e.g. Alex">
                                        <span class="la la-user input-icon"></span>
                                        @error('username')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control  @error('email') is-invalid @enderror"
                                            type="email" name="email" placeholder="e.g. alexscott@gmail.com">
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control  @error('phone') is-invalid @enderror"
                                            type="text" name="phone" placeholder="e.g. 07092193201">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control  @error('address') is-invalid @enderror"
                                            type="text" name="address" placeholder="e.g. No4 Ajawo-Estate Ikeja Nigeria">
