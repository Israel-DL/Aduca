                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('register') }}" class="pt-4">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="la la-lock input-icon"></span>
                                        <input class="form-control form--control password-field" id="password_confirmation"
                                ...
                                <div class="btn-box">
                                    ...
                                    <button class="btn theme-btn" type="submit">Create Account <i
