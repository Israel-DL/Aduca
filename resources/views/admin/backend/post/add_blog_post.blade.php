...
<div class="page-content">
				...
				<div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4">Create Blog Post Form</h5>
								<form id="myForm" action="{{ route('store.blog.post') }}" method="post"  class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="input1" name="post_title" placeholder="Blog Post Title">
									</div>
                                    ...
                                    <div class="form-group col-md-6">
										...
										<input type="text" class="form-control" data-role="tagsinput" value="jQuery" name="post_tags">
									</div>
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="submit" class="btn btn-primary px-4">Create Blog Post</button>
										</div>
									</div>
								</form>
							</div>
