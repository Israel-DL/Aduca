...
<div class="page-content">
				...
				<div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4">Edit Category Form</h5>
								<form id="myForm" action="{{ route('update.category') }}" method="post"  class="row g-3" enctype="multipart/form-data">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="input1" name="category_name" placeholder="Category Name" value="{{ $category->category_name }}">
									</div>
