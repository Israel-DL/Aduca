...
<div class="page-content">
				...
				<div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4">Add Admin Form</h5>
								<form id="myForm" action="{{ route('store.admin') }}" method="post"  class="row g-3">
                                    ...
                                    <div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="input1" name="username" placeholder="UserName">
									</div>

                                    
                                    <div class="form-group col-md-6">
										<label for="input1" class="form-label">Email</label>
										<input type="email" class="form-control" id="input1" name="email" placeholder="Email">
									</div>
                                    ...
                                    {{-- <div class="form-group col-md-6">
										...
										<input type="password" class="form-control" id="input1" name="email" placeholder="Confirm Password">
									</div> --}}
