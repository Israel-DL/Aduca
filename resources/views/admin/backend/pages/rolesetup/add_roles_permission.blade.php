							...
							<div class="card-body p-4">
								...
								<form id="myForm" action="{{ route('role.permission.store') }}" method="post"  class="row g-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" value="" id="flexCheckMain" class="form-check-input">
                                        <label for="flexCheckMain" class="form-check-label">Permission All</label>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" value="{{ $permission->id }}" name="permission[]" id="checkDefault{{ $permission->id }}" class="form-check-input">
