...
<!-- @if ($status === '1')
<h4>Instuctor Account Is <span class="text-success">Active</span></h4>
@else
<h4>Instuctor Account Is <span class="text-danger">Inactive</span></h4>
<p class="text-danger"> <b>Admin will activate your account in 24hrs</b> </p>
@endif -->
