...
<div class="page-content">
				...
				<div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4">Create Course Form</h5>
								...
								<form id="myForm" action="{{ route('store.course') }}" method="post"  class="row g-3" enctype="multipart/form-data">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="input1" name="course_name" placeholder="Course Name">
									</div>

                                    <div class="form-group col-md-6">
										<label for="input1" class="form-label">Course Title</label>
										<input type="text" class="form-control" id="input1" name="course_title" placeholder="Course Title">
									</div>
