								...
								<form id="myForm" action="{{ route('update.course') }}" method="post"  class="row g-3" enctype="multipart/form-data">
									...
									<div class="form-group col-md-6">
										...
										<select name="label" class="form-select mb-3" aria-label="Default select example">
											...
											<option value="Intermidiate" {{$course->label == 'Intermidiate' ? 'selected' : ''}}>Intermidiate</option>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('update.course.video') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <button type="submit" class="btn btn-primary px-4">Update Course Intro Video</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('update.course.goals') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <button type="submit" class="btn btn-primary px-4">Update Course Goals</button>
                    </div>
                </div>
            </form>
        </div>
