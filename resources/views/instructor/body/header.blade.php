					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-large">
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" data-bs-toggle="dropdown"><span class="alert-count" id="notification-count">{{ $notificationcount }}</span>
